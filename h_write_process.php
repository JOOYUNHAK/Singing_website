...
$auto = "alter table hiphop auto_increment = 1"; //글 번호 초기화
...
if(strcmp($now_id, $id) != 0){ ?>
      ...
      while($p_row = mysqli_fetch_array($p_sql)){
            ...
            <?php }
                ...
                $sql = "insert into hiphop(title, pwd, id, content, w_date, category) values
                        ('$title', '$pwd', '$id', '$content', '$date', 'hiphop')";
