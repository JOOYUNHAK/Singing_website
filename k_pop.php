...
<!doctypehtml>
  ...
  <body>
    ...
    <h1 align=center>K-POP존 자유게시판</h1>
    <h2 align=center>K-POP만 추천해주세요!</h2>
...
<?php   $total_sql2 = "select * from k_pop order by up desc, list_nu desc limit $start_num, $list";
      ...
      <tr>
        ...
        <td width = "500"><a href = "k_read.php?list_nu=<?php echo $board["list_nu"]?>">
      ...
      <?php    }else { //일반 회원일경우?>
                        <a href="k_write.php"><button>글쓰기</button></a>
      <?php    } }
                else  { //비로그인일 경우?>
                <a href="k_write.php"><button>글쓰기</button></a>
      <?php }  ?>
  ...
  <div id="search">
  <form action="k_result.php" method="get">
    <select name="menu">
