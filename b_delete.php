<?php
    ...
    $id_sql = "select * from ballad where list_nu = $list_nu";
    ...
    <?php }
             ...
             label:
             $sql = "delete from ballad where list_nu = $list_nu";
             $result = mysqli_query($con, $sql);
              //베스트게시판
             $b_sql = "select * from bestboard where list_nu= $list_nu and category= 'ballad'";
             $b_result=mysqli_query($con, $b_sql);
             if($b_result){
             $d_sql = "delete from bestboard where list_nu=$list_nu and category = 'ballad'";
