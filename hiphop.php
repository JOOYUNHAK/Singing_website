...
<!doctypehtml>
  ...
  <body>
    ...
    <h1 align=center>힙합존 자유게시판</h1>
    <h2 align=center>힙합 노래만 추천해주세요!</h2>
    ...
    <?php
        ...
        <tr>
          ...
          <td width = "500"><a href = "notice_read.php?list_nu=<?php echo $notice["list_nu"]?>">
                                  <?php echo $n_title;?><?php echo $img; ?><font></td>
...
<?php        $total_sql2 = "select * from hiphop order by up desc, list_nu desc limit $start_num, $list";
...
<?php    }else { //일반 회원일경우?>
              <a href="h_write.php"><button>글쓰기</button></a>
<?php    } }
      else  { //비로그인일 경우?>
      <a href="h_write.php"><button>글쓰기</button></a>
<?php }  ?>
