    ...
    <table class="table_list">
      <thead>
        ...
        <?php
          ...
          $total_sql = "select * from ballad where $menu like '%$search_result%' order by list_nu desc";
          ...
          $sql = "select * from ballad where $menu like '%$search_result%' order by list_nu desc";
