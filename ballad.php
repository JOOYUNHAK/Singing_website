...
<!doctypehtml>
  ...
  <body>
    ...
    <h1 align=center>발라드존 자유게시판</h1>
    <h2 align=center>발라드 노래만 추천해주세요!</h2>
  ...
  <table class = "table_list">
    ...
    <?php
        ...
        $total_sql2 = "select * from ballad order by up desc, list_nu desc limit $start_num, $list";
      ...
      <tr>
        ...
        <td width = "500"><a href = "b_read.php?list_nu=<?php echo $board["list_nu"]?>">
      ...
      <?php    }else { //일반 회원일경우?>
                      <a href="b_write.php"><button>글쓰기</button></a>
      <?php    } }
              else  { //비로그인일 경우?>
              <a href="b_write.php"><button>글쓰기</button></a>
      <?php }  ?>
  ...
  <div id="search">
  <form action="b_result.php" method="get">
    <select name="menu">
